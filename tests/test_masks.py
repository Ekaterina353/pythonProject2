...
@pytest.mark.parametrize(
    ...
    [("один", "Номер карты должен состоять из 16 цифр"), ("1", "Номер карты должен состоять из 16 цифр"), ('123456789012345a', "Номер карты должен состоять из 16 цифр")],
)
...
@pytest.mark.parametrize(
    ...
    [("один", "Номер счета должен состоять минимум из 4 цифр"), ("1", "Номер счета должен состоять минимум из 4 цифр"), ('123456789012345a', "Номер счета должен состоять минимум из 4 цифр")],
)
